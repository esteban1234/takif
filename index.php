...
<article class="banner">
  ...
  <article class="contenlogocorreo">
    <figure class="pull-left primary-img">
...
<article class="seccionmercados">
  ...
  <article class="contenmercados">
    <div class="uno">
      ...
      <h3 class="text-center text-size">HOSPITALES</h3>
     ...
     <div class="uno">
      ...
      <h3 class="text-center text-size">TELECOMUNICACIONES</h3>
      <div class="unopuntodos">
     ...
     <div class="uno">
      ...
      <h3 class="text-center text-size">CONSTRUCTORAS</h3>
      <div class="unopuntodos">
     ...
     <div class="uno">
      ...
      <h3 class="text-center text-size">SUPERMERCADOS</h3>
      <div class="unopuntodos">
